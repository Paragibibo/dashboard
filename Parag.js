...
{}
  ...
  await pagePromise
   ...
   try {await page.waitForResponse( response => {
    if(response.status() === 200 && response.url().match('https://hermes.goibibo.com/hotels/v7/detail/price/v3/8717279093827200968/20190705/20190706/1-2-0/2949253418177622573') ){
      console.log(response.url());
 return true; 
}},{timeout:3000})} 
 catch(err)
